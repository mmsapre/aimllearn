#Lesson: Variables, Data Types, and Operators for AI

Welcome to AI/ML journey! Today we learn how Python's fundamental data types form the building blocks of AI systems.
...
- Build a simple "Agent memory system"
...
```bash
python learnings_code.py
```

### 3. Verify Your Learning
```bash
python test_your_learning.py
```
...
└── learning_env/        # Virtual environment (created by setup)
```
...
*** Control Flow** - Learn if/else statements and loops that let your AI agent make intelligent decisions based on the data you learned to store today.
