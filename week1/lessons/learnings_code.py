#!/usr/bin/env python3
"""
Learnings : Variables, Data Types, and Operators for AI
teaches Python data types from AI / ML AI/ML applications perspective.
You will learn variables and operators building foundation of AI systems.
"""
